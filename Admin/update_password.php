    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST"){
        if(isset($_POST['submit'])){
            ...
            if($execute == TRUE){
                ...
                Header('location:'.APP_URL.'admin/manage_user.php?id='.$id);
            }else{
                $_SESSION['message']= '<div class="error">could not update password .Try Again!!</div>';
                Header('location:'.APP_URL.'admin/update_password.php?id='.$id);
            ...
            Header('location:'.APP_URL.'admin/update_password.php?id='.$id);
                ...
                $_SESSION['message'] = '<div class="error">could not found user</div>';
                Header('location:'.APP_URL.'admin/update_password.php?id='.$id);
            }
        }else{
